...
/**
 * This public class shows the final string of the variable.
 */
public class RPSLSpock {
     ...
     *
     * @param pick
     * @return this return an false expression because this explain if the pick is equal to null.
     */
    ...
    /**
     *
     * @return This string returns the pick. for example if case is equal to a number like 0 the program
     * will break and return Rock.
     */
     ...
     * @param c_pick
     * @param h_pick
     * @return This is a boolean and This returns ComputerWin for example if rock beats paper its going to show true if not
     * it will show false. There will be many outcomes for the Lizard Spock game.
     */
